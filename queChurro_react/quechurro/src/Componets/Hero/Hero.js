    ...
    <div className="container">
      <div className="row justify-content-between gy-5">
        <div className="col-lg-5 order-2 order-lg-1 d-flex flex-column justify-content-center align-items-center align-items-lg-start text-center text-lg-start">
          <h2 data-aos="fade-up" >FOODTRUCK DE<br/>CHURROS</h2>
          <p data-aos="fade-up" data-aos-delay="100">Vamos a tu fiesta o evento dando una experiencia divertida y distintiva</p>
        ...
        <div className="col-lg-5 order-1 order-lg-2 text-center text-lg-start">
          <img src={queChurroLogo} className="img-fluid" alt="" data-aos="zoom-out" data-aos-delay="300"/>
        </div>
      </div>
    </div>
  </section>
